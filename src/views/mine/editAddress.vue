<template>
  <div class="edit-address">
    <cm-header>
      ...
      <i>修改所在地区</i>
      <span slot="right" class="delete-addrss" @click="handleDeleteAddress"
        >删除</span
      >
    </cm-header>
      ...
      <ul class="address-list">
        ...
        <li class="address-item">
          ...
          <div class="address-name" @click="showPicker">
            <van-field
              v-model="addressInfo.fullAddress"
              disabled
              placeholder="请选择省市区"
            />
            <div>
    ...
    <div class="address-btn">
      <router-link to="/mine/addAddress">
        <van-button type="danger" size="large" @click="handleSeveAddresInfo"
          >保存</van-button
        >
      </router-link>
    </div>
      ...
      <div class="address">
        <div class="addressbox">
          <p class="text_btn">
            ...
            <span style="float:right;color:#EC3924;" @click="complete"
              >完成</span
            >
          </p>
