  ...
  <div class="product-layout">
    ...
    <ul class="product-content">
      <li class="product-title">
        <div class="text-left">
          <span v-if="detailForm.calculate" class="force-value"
            >{{ detailForm.calculate }}算力值</span
          >
      ...
      <li class="item-info">
        <van-field
          label="发货地"
          disabled
          :placeholder="detailForm.shipAddress"
        >
      ...
      <li class="item-info" @click="handleShowSpecs">
        <van-field
          label="选择"
          disabled
          :placeholder="handleProductSpeces()"
        ></van-field>
        <van-icon name="arrow" />
      </li>
      <li class="store-info">
    ...
    <div class="item-details">
      ...
      <div
        v-html="detailForm.productDetail"
        v-show="showDetail"
        class="html-class"
      ></div>
    </div>
      ...
      <template slot="sku-header-price" slot-scope="props">
        <div class="van-sku__goods-price">
          ...
          <span class="van-sku__price-num">{{
            parseFloat((props.price * 100).toPrecision(12))
          }}</span>
        </div>
        <span class="sku-calculate" v-if="calculate"
          >{{ calculate }}倍算力值</span
        >
        <div class="van-sku-header-item" v-show="stockNum">
          <span class="van-sku__stock" v-if="stockNum"
            >剩余{{ stockNum }}件</span
          >
        </div>
